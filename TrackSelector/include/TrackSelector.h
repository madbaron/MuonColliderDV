 ...
 * @version $Id: TrackSelector.h,v 0.1 2022-05-19 12:57:39 fmeloni Exp $
 */

class TrackSelector : public Processor
{

public:
  virtual Processor *newProcessor() { return new TrackSelector; }

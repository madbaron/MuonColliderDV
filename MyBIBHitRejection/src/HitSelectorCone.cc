...
HitSelectorCone aHitSelectorCone;

HitSelectorCone::HitSelectorCone() : Processor("HitSelectorCone")
{

  // --- Processor description:

  _description = "HitSelectorCone selects tracker hits in a cone opened around a MC particle direction";
...
void HitSelectorCone::processRunHeader(LCRunHeader *run)
{

  _nRun++;
}

void HitSelectorCone::processEvent(LCEvent *evt)
{
...
void HitSelectorCone::check(LCEvent *evt)
{
}

void HitSelectorCone::end()
{

  std::cout << "HitSelectorCone::end()  " << name()

...
int VertexingUtils::get_nTracks(ROOT::VecOps::RVec<lcio::TrackImpl> tracks)
{
  int nt = tracks.size();
  return nt;
}
...
TVectorD
VertexingUtils::get_trackParam(lcio::Track &atrack)
{
  double d0 = atrack.getD0();
  double phi0 = atrack.getPhi();
  double omega = atrack.getOmega();
  double z0 = atrack.getZ0();
...
TMatrixDSym
VertexingUtils::get_trackCov(lcio::Track &atrack)
{
  std::vector<float> covMatrix = atrack.getCovMatrix();
  TMatrixDSym covM(5);
...
int VertexingUtils::get_Nvertex(ROOT::VecOps::RVec<FCCAnalysesVertex> TheVertexColl)
{
  return TheVertexColl.size();
}

lcio::VertexImpl VertexingUtils::get_VertexData(FCCAnalysesVertex TheVertex)
{
  return TheVertex.vertex;
}

ROOT::VecOps::RVec<lcio::VertexImpl> VertexingUtils::get_VertexData(ROOT::VecOps::RVec<FCCAnalysesVertex> TheVertexColl)
{
  ROOT::VecOps::RVec<lcio::VertexImpl> result;
...
lcio::VertexImpl VertexingUtils::get_VertexData(ROOT::VecOps::RVec<FCCAnalysesVertex> TheVertexColl, int index)
{
